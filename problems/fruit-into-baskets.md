...
## Tags - 题目标签
 ...
 <img src="https://img.shields.io/badge/Array-数组-blue.svg">   <img src="https://img.shields.io/badge/Hash Table-哈希表-blue.svg">   <img src="https://img.shields.io/badge/Sliding Window-滑动窗口-blue.svg">  
...
[LeetCode](https://leetcode.com/problems/fruit-into-baskets/description/)  -  [LeetCode-CN](https://leetcode-cn.com/problems/fruit-into-baskets/description/)
## Latest Accepted Submissions - 最近一次 AC 的提交


| Language | Runtime | Memory | Submission Time |
|:---:|:---:|:---:|:---:|
| cpp  | 152 ms | 64 MB | 2022/03/14 13:14 |
...
public:
    int totalFruit(vector<int>& fruits) {
        map<int,int> m;
        int i = 0,ret = 0, windowsum = 0,windowsize = 0;
        for(int j = 0;j < fruits.size();j++){
            ...
            while(m.size()>2){
                windowsum --;
                ret = ret > windowsum ? ret : windowsum;
                if(m[fruits[i]] == 1){
                    m.erase(fruits[i]);
                }else{
                    m[fruits[i]] --;
        ...
        return ret > windowsum ? ret : windowsum;
    }
};
